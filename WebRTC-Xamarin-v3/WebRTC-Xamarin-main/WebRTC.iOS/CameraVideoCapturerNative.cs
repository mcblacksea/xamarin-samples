...
{
    public class CameraVideoCapturerNative : NativeObjectBase, ICameraVideoCapturer
    {
        private const float FramerateLimit = 30.0f;

        private readonly RTCCameraVideoCapturer _capturer;
        public RTCCameraVideoCapturer Capturer => _capturer;
        ...
        public void StartCapture(int videoWidth, int videoHeight, int fps)
        {
            ...
            var position = _usingFrontCamera ? AVCaptureDevicePosition.Front : AVCaptureDevicePosition.Back;
